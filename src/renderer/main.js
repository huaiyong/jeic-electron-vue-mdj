...
// 牡丹江接口
 Vue.prototype.configure = {
  jeucIp:"http://218.9.54.64:9099/jeuc/api", //用户中心接口 获取用户数据
  resourceIp:"http://218.9.54.64:9099/Teacher", //教师端获取资源列表接口
  recordIp: 'http://localhost:8081/photoBack/getsendPhotos?',
  showResourceIp: 'http://218.9.54.49:8888/edu-resource/a/resource/mrs_rmi/getById?token=29B5DF07F7FC514807CE5FBC12EA1506&id=', // 显示资源详情接口
  videoPlay: 'http://218.9.54.49:8888/resource/Preview/', // 视频播放固定地址
}; 
